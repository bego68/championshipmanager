...
CREATE TABLE tx_championshipmanager_domain_model_tournround (
	...
	name varchar(255) DEFAULT '' NOT NULL,
	groupround int(11) unsigned DEFAULT '0' NOT NULL,
	koround int(11) unsigned DEFAULT '0',
...
#
# Table structure for table 'tx_championshipmanager_domain_model_groupround'
#
CREATE TABLE tx_championshipmanager_domain_model_groupround (
...
#
# Table structure for table 'tx_championshipmanager_domain_model_koround'
#
CREATE TABLE tx_championshipmanager_domain_model_koround (
