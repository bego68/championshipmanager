...
CREATE TABLE tx_championshipmanager_domain_model_groupteams (
	...
	wonsets int(11) DEFAULT '0' NOT NULL,
	lostsets int(11) DEFAULT '0' NOT NULL,
	wonballs int(11) DEFAULT '0' NOT NULL,
	lostballs int(11) DEFAULT '0' NOT NULL,
	wonmatches int(11) DEFAULT '0' NOT NULL,
